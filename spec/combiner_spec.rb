...
describe Combiner do
  ...
  context "#combine" do
    ...
    context "when there is only one enumerator" do
      let(:input_enumerators) { [enumerator_for(1, 1, 2, 3)] }
      it { should_not be_empty }
      it "should return exact same elements in the arrays" do
        should return_elements [1], [1], [2], [3]
      end
    end
